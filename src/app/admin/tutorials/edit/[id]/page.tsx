...
import { Save, Code as CodeIcon, Loader2 } from 'lucide-react'
...
export default function EditTutorialPage({ params }: { params: { id: string } }) {
  ...
  const loadTutorial = async () => {
    try {
      const tutorial = await tutorialAPI.getById(parseInt(params.id))
      setFormData({
      ...
      <AdminSidebar>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400">Loading tutorial...</p>
          </div>
        </div>
      </AdminSidebar>
    )
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">Edit Tutorial</h1>
