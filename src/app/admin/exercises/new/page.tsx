...
import { createExercise } from '@/lib/api/admin'
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-1">Create New Exercise</h1>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Add a new coding exercise in both English and Bengali
              </p>
            </div>
          </div>
